...
subprocess.run(["nfd-start","-c","NFD_low_CS.conf"], stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
time.sleep(10)
...
traffic_output = subprocess.run(["ndn-traffic-client", "-c", "20", "ndn-traffic-client.conf"], stdout=subprocess.PIPE)
