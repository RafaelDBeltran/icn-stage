    ...
    if command == 'start':
        ...
        try:
            ...
            for auxiliar in data['auxiliars']:
                ...
                channel.put('./experiments/test_traffic/low.conf','{} + low.conf'.format(auxiliar['default_home']))
                channel.put('./experiments/test_traffic/traffic_server.py','{}+traffic_server.py'.format(auxiliar['default_home']))
                channel.put('./experiments/test_traffic/ndn-traffic-server.conf','{}+ndn-traffic-server.conf'.format(auxiliar['default_home']))
