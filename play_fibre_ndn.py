...
def get_file_name(fail, actors, experiment_length_secs=EXPERIMENT_LENGTH_SECS):
	...
	if UDP:
		transport = "_udp"
	name = 'results_fail-{}_recover-{}_length-{}s{}.txt'.format(fail_str, recover_str, experiment_length_secs, transport)
...
def start_mininet():
	#TODO restart fibre
	#TODO change to default iptbles
...
def main():
	...
	logging.info("---------------------")
	fileout = "length-{}s_dirsleep-{}_{}".format(EXPERIMENT_LENGTH_SECS, DIRECTOR_SLEEP_SECS, transport)
